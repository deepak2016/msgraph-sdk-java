...
/**
 * The class for the Base Education User With Reference Request.
 */
public class BaseEducationUserWithReferenceRequest extends BaseRequest implements IBaseEducationUserWithReferenceRequest {
     ...
     */
    public BaseEducationUserWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
